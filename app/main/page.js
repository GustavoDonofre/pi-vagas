...
>>>>>>>> 5236227dac0be05ea4a4d424731e59b080cd1742:app/main/components/backup_paginainicial.js
                ...
                <div className="sobre card mt-5 col-8">
                    <h2 className="fw-bold text-center mb-3">✨ Como funciona?</h2>
                    ...
                    <div className="row mt-4 text-center">
                        ...
                        <div className="col-md-6 mb-3">
                            ...
                            <p className="text-muted">⌨️ Crie sua conta gratuitamente e encontre oportunidades.</p>
                        </div>

                        <div className="col-md-6 mb-3">
                            <h5>🏢 Para Empresas</h5>
                            <p className="text-muted">🖱️ Cadastre sua empresa e publique vagas facilmente.</p>
                        </div>
                    </div>
